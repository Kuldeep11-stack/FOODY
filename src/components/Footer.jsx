...
const Footer = () => {
  return (
    <div className="hidden md:flex flex-col">
      <footer className="footer xl:px-24 py-10 px-4 bg-white text-base-content mt-12 sm:items-center">
        <aside>
          <img src="/logo.png" alt="" className="mb-5" />
          <p className="font-medium text-[#555555] w-3/4">
      ...
      <br />
      <footer className="footer items-center xl:px-24 py-10 px-4 bg-white text-[#555555]">
